...
import { reportEmailTemplate } from "@/lib/email-templates";
          ...
          try {
            ...
            await getResend().emails.send({
              ...
              html: reportEmailTemplate({
                ...
                dateRange: dateLabel,
                summaryFields: `${summary.message.replace(/\*/g, "")}<br/><span style="font-size:13px;color:#71717a;">${summaryFields}</span>`,
                appUrl,
              }),
              attachments: [
                {
